...
public class EquipmentConsoleTractorAdjustmentsStepDef {
    ...
    @Given("^Run Test for \"([^\"]*)\" on Browser \"([^\"]*)\" and Enter the url for Equipment Console Tractor Adjustments$")
    public void run_Test_for_on_Browser_for_Equipment_Console_and_Enter_the_url_for_Equipment_Console_Tractor_Adjustments(String environment1, String browser) {
        BrowserDriverInitialization browserDriverInitialization = new BrowserDriverInitialization();
    ...
    @And("^Login to the Portal with USERNAME \"([^\"]*)\" and PASSWORD \"([^\"]*)\" for Equipment Console Tractor Adjustments$")
    public void login_to_the_Portal_with_USERNAME_and_PASSWORD_for_Equipment_Console_Tractor_Adjustments(String username, String password) {
    ...
    @Given("^Click on NO on alert for Tractor Adjustments$")
    public void click_on_NO_on_alert_for_Tractor_Adjustments() {
        driver.findElement(equipmentConsolePage.alert).isDisplayed();
        driver.findElement(equipmentConsolePage.alertNo).click();
    }
    ...
    //....................../ 37a @IdentifyINVOICEforTractorReimbursement /..............................//
    ...
    public void Locate_a_Record_from_Database_for_Tractor_Reimbursement_Agent_Status_must_have_a_Status_of_Agent_Review_or_Corp_Review(String environment, String tableName1, String createdDate) throws SQLException, ClassNotFoundException, InstantiationException, IllegalAccessException {
        // SQL#1
        System.out.println("=========================================");
        ...
        String query = ";WITH \n" +
                ...
                "    From [EBH].[dbo].[Agent_Pay_Matrix] With(Nolock)\n" +
                ...
                "    From [Evans].[dbo].[InvoiceRegisterRecord] With(Nolock)\n" +
                ...
                "    From [EBH].[dbo].[AGENT_SETTLEMENT_INFO]  With(Nolock)\n" +
                ...
                "    From [EBH].[dbo].[Agent_Settlements] With(Nolock)\n" +
                ...
                "Inner join [EBH].[dbo].[Orders] o With(Nolock) on o.Ord_loc = irr.Agent and o.Ord_num = irr.ProNumber\n" +
                "Inner join [EBH].[dbo].[Locations] L With(Nolock) on l.LOCATION_CODE = o.ord_loc\n" +
...
//................................/ 37b @AgentReimbursement /.......................................//
 ...
 /*   @Given("^Enter Invoice Number \"([^\"]*)\" in Search Criteria on Equipment Console Interface$")
    public void enter_Invoice_Number_in_Search_Criteria_on_Equipment_Console_Interface(String invoiceNo) throws InterruptedException {
        driver.findElement(equipmentConsolePage.invoice).sendKeys(invoiceNo);
        driver.findElement(equipmentConsolePage.refresh).click();
        Thread.sleep(5000);
    }

    @Given("^Select Agent Status Button for a record that has a Agent Status, Agent Review or Corp Review \"([^\"]*)\"$")
    public void select_Agent_Status_Button_for_a_record_that_has_a_Agent_Status_Agent_Review_or_Corp_Review(String agentStatus) {
    ...
    @Given("^Select Agent \"([^\"]*)\" and ProNo \"([^\"]*)\"$")
    public void select_Agent_and_ProNo(String agent, String proNum) throws InterruptedException {
        Thread.sleep(3000);
    ...
    @Given("^Select Agent Reimbursement on Status \"([^\"]*)\"$")
    public void select_Agent_Reimbursement_on_Status(String agentReimbursement) throws InterruptedException {
        Thread.sleep(4000);
