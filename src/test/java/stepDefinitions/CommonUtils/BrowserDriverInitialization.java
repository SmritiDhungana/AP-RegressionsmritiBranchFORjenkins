...
public class BrowserDriverInitialization {
    ...
    public Connection getConnectionToDatabase1(String environment1) throws ClassNotFoundException, InstantiationException, IllegalAccessException, SQLException {
        String dbClass = "com.microsoft.sqlserver.jdbc.SQLServerDriver";
        Class.forName(dbClass).newInstance();
